...
const HomePriv = () => {
  ...
  return (
    ...
    <h2 className="content-proyect-title">Epicas</h2>
      <p className="content-proyect-paragraph">Divide tu proyecto en epicas</p>
    </div>
    <div className="content-proyect">
    <svg class="icon icon-tabler icon-tabler-list-details" fill="none" height="120" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="120" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none" stroke="none"/><path d="M13 5h8"/><path d="M13 9h5"/><path d="M13 15h8"/><path d="M13 19h5"/><rect height="6" rx="1" width="6" x="3" y="4"/><rect height="6" rx="1" width="6" x="3" y="14"/></svg>
      <h2 className="content-proyect-title">Historias</h2>
      <p className="content-proyect-paragraph">Gestiona historias para un seguimiento detallado</p>
    </div>
    <div className="content-proyect">
    <svg className='icon-tabler' xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" style={{fill:"rgb(8, 185, 141)"}}><path d="m10.933 13.519-2.226-2.226-1.414 1.414 3.774 3.774 5.702-6.84-1.538-1.282z"></path><path d="M19 3H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM5 19V5h14l.002 14H5z"></path></svg>
